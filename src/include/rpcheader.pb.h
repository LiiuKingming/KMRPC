...
PROTOBUF_NAMESPACE_OPEN
template<> ::kmrpc::RpcHeader* Arena::CreateMaybeMessage<::kmrpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace kmrpc {
...
class RpcHeader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kmrpc.RpcHeader) */ {
 public:
  RpcHeader();
  virtual ~RpcHeader();
  ...
  // @@protoc_insertion_point(class_scope:kmrpc.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:kmrpc.RpcHeader.service_name)
  return _internal_service_name();
}
inline void RpcHeader::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:kmrpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:kmrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:kmrpc.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:kmrpc.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:kmrpc.RpcHeader.service_name)
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:kmrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kmrpc.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:kmrpc.RpcHeader.method_name)
  return _internal_method_name();
}
inline void RpcHeader::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:kmrpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:kmrpc.RpcHeader.method_name)
...
inline void RpcHeader::set_method_name(std::string&& value) {
  ...
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:kmrpc.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:kmrpc.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const void* value, size_t size) {
  ...
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:kmrpc.RpcHeader.method_name)
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:kmrpc.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kmrpc.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:kmrpc.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:kmrpc.RpcHeader.args_size)
}
